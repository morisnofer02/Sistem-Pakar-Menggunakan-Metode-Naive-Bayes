...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; Morisnna02 <?= date('Y'); ?></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<!-- Page level plugins -->
<script src="<?= base_url('assets3/'); ?>vendor/datatables/jquery.dataTables.min.js"></script>
<script src="<?= base_url('assets3/'); ?>vendor/datatables/dataTables.bootstrap4.min.js"></script>

<!-- Page level custom scripts -->
<script src="<?= base_url('assets3/'); ?>js/demo/datatables-demo.js"></script>
