            ...
            <div id="register">
                <section class="login_content">
                    <form method="post" action="<?= base_url('auth/registrasi') ?>">
                        <h1>Buat Akun</h1>
                        <div>
                            <input type="text" class="form-control" placeholder="Masukkan Nama Anda" id="nama" name="nama" value="<?= set_value('nama'); ?>" />
                        ...
                        <div class="separator">
                            ...
                            <div>
                                <a href="<?= base_url('home'); ?>">
                                    <h1><i class="fa fa-desktop"></i> Home</h1>
                                </a>
                                <p>© Copyright <?= date('Y'); ?> Sistem Pakar Mendeteksi Kerusakan Smartphone morisnofer</p>
                            </div>
                        </div>
                    </form>
                </section>
