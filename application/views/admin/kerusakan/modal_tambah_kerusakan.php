        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kode" name="kode_kerusakan" placeholder="Kode kerusakan" value="<?= $kode; ?>" readonly>
                </div>

                <div class="form-group">
                    <label for="nama">Nama Kerusakan</label>
                    <input type="text" class="form-control" id="nama" name="nama_kerusakan" placeholder="Nama Kerusakan">
                </div>
