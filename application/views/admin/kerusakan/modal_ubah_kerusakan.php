            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kode" name="kode_kerusakan" value="<?= $rusak['kode_kerusakan']; ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="nama">Nama Kerusakan</label>
                        <input type="text" class="form-control" id="nama" name="nama_kerusakan" value="<?= $rusak['nama_kerusakan']; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <img style="margin-bottom: 10px; width: 100px;" src=" <?= base_url('assets3/img/kerusakan/') . $rusak['gambar']; ?>">
